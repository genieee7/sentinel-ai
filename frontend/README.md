...
- **랜딩 페이지**: [http://localhost:3000](http://localhost:3000)
- **채팅 페이지**: [http://localhost:3000/chat](http://localhost:3000/chat)
- **색상 가이드**: [http://localhost:3000/colors](http://localhost:3000/colors)
